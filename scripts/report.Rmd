...
params:  
  ...
  prokka_denovo_folder: "prokka_denovo_folder"
...
cat( "<div class='textright'> version ", params$version,"</div>   \n")
```
...
cat( "  - **Annotations** ", params$prokka_denovo_folder,"   \n")
```
...
cat( "  - **QC:** ", params$novoassembly_path_QC,"   \n")
cat( "  - **Annotations** ", params$prokka_chr_folder,"   \n")
```
...
cat( "  - **Annotations** ", params$prokka_plasmids_folder,"   \n")
```
...
cat( "  - **Annotations** ", params$pharokka_folder,"   \n")
```
